...
namespace Unity.RenderStreaming
{
    ...
    public class SimpleCameraController : MonoBehaviour, IRemoteInput
    {
        class CameraState
        {
            public float yaw;
...
//---------------------------------------------------------------------------------------------------------------------
        ...
        void UpdateTargetCameraStateFromInput(Vector2 input)
        {
            ...
            float mouseSensitivityFactor = input.magnitude * 0.01f;
...
//---------------------------------------------------------------------------------------------------------------------
        ...
        Vector3 GetInputTranslationDirection()
        {
            ...
            {
                direction += Vector3.forward * m_movementSensitivityFactor;
            }
            if (m_keyboard.sKey.isPressed)
            {
                direction += Vector3.back * m_movementSensitivityFactor;
            }
            if (m_keyboard.aKey.isPressed)
            {
                direction += Vector3.left * m_movementSensitivityFactor;
            }
            if (m_keyboard.dKey.isPressed)
            {
                direction += Vector3.right * m_movementSensitivityFactor;
            }
            if (m_keyboard.qKey.isPressed)
            {
                direction += Vector3.down * m_movementSensitivityFactor;
            }
            if (m_keyboard.eKey.isPressed)
            {
                direction += Vector3.up * m_movementSensitivityFactor;
            }
