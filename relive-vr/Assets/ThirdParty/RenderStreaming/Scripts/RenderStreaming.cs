...
#pragma warning restore 0649
        ...
        private readonly Dictionary<RemoteInput, IRemoteInput> m_remoteInputAndCameraController = new Dictionary<RemoteInput, IRemoteInput>();
        ...
        private readonly List<IRemoteInput> m_listController = new List<IRemoteInput>();
        ...
        public void AddController(IRemoteInput controller)
        {
            m_listController.Add(controller);
            controller.SetInput(m_defaultInput);
        }

        public void RemoveController(IRemoteInput controller)
        {
        ...
        void OnDataChannel(RTCPeerConnection pc, RTCDataChannel channel)
        {
            ...
            var controller = m_listController
